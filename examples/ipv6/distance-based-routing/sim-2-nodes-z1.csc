...
<simconf>
  ...
  <simulation>
    <title>Distance based routing simulation</title>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/ipv6/distance-based-routing/udp-server.c</source>      
      <commands EXPORT="discard">make -j udp-server.z1 TARGET=z1</commands>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/ipv6/distance-based-routing/udp-client.c</source>      
      <commands EXPORT="discard">make -j udp-client.z1 TARGET=z1</commands>
